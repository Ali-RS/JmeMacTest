...
This is the readme for JmeMacTest, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. JmeMacTest) > Ok.
...
- To run the project find JmeMacTest.java (which will be in under src/main/java/jmetest) and right click > Run 'JmeMacTest'
